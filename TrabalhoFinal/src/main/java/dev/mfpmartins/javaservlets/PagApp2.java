...
public class PagApp2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (!request.isRequestedSessionIdValid()) {
            ...
            response.sendRedirect("PagLogin?erro=" + URLEncoder.encode("Erro: sem sessão em PagApp2", "UTF-8"));
        } else {
            ...
            out.println("<title>PagApp2</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>PagApp2</h2>");
            listaCookies(request, out);
            out.println("<br>");
            out.println("<a href=\"PagApp1\">PagApp1</a><br>");
    ...
    private void listaCookies(HttpServletRequest request, PrintWriter out) 

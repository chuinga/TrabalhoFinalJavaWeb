<%--
    Document   : P12_Session_03Pagina2.jsp
...
<%
    ...
    if (!request.isRequestedSessionIdValid()) {
        ...
        response.sendRedirect(response.encodeRedirectURL(
                "P12_Session_01Login.jsp?erro=" + URLEncoder.encode("Erro: Sessão inválida em P12_Session_03Pagina2.jsp", "UTF-8")));
        return;
    }
%>
<!DOCTYPE html>
...
<head>
<meta charset="UTF-8">
<title>P12_Session_03Pagina2</title>
</head>
<body>
    <h1>Página 2 da Aplicação</h1>
    <%
    ...
    <br>
    <br>
    <a href="<%= response.encodeURL("P12_Session_03Pagina1.jsp") %>">P12_Session_03Pagina1.jsp</a><br>
